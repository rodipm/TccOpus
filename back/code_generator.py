    ...
    if current_node_number not in visited_nodes:
        ...
        if current_node['type'] == 'PollingConsumer' or current_node['type'] == "Message":
            ...
            for child_node_number in current_node['connectsTo']:
                ...
                # return new_generated_code + generate_code(items_info, child_node_number, generated_code, new_visited_nodes, dependencies)
        ...
        if current_node['type'] == 'MessageFilter':
            ...
            # return generated_code + new_generated_code + generate_code(items_info, child_node_number, generated_code, new_visited_nodes, dependencies)
